...
# Train
print('Calling .train')
gnn_test.train(data_in,data_out)

# Save
print('Saving model...')
torch.save(gnn_test,'gnn_flowbench.pth')
print('done')

# Eval
print('Evaluating...')
fno_test = torch.load('gnn_flowbench.pth',weights_only=False)
x0 = data_in[0:2]
data_pred = gnn_test.eval(x0)
